...
AL["Tier Sets"] = true
AL["Tier %s Sets"] = true
AL["Silithus Abyssal"] = true
AL["Abyssal Dukes"] = true
AL["The Duke of Cynders"] = true
AL["The Duke of Fathoms"] = true
AL["The Duke of Zephyrs"] = true
AL["The Duke of Shards"] = true
AL["Abyssal Lords"] = true
AL["Prince Skaldrenox"] = true
AL["Lord Skwol"] = true
AL["High Marshal Whirlaxis"] = true
AL["Baron Kazum"] = true
AL["Abyssal Templars"] = true
AL["Crimson Templar"] = true
AL["Azure Templar"] = true
AL["Hoary Templar"] = true
AL["Earthen Templar"] = true
AL["Elemental Invasions"] = true
AL["Baron Charr"] = true
AL["Princess Tempestria"] = true
AL["Avalanchion"] = true
AL["The Windreaver"] = true
AL["Gurubashi Arena"] = true
AL["Stranglethorn Fishing Extravaganza"] = true
AL["First Prize"] = true
AL["Rare Fish"] = true
AL["Rare Fish Rewards"] = true
AL["Childrens Week"] = true
AL["Valentineday"] = true
...
AL["Smokywood Pastures Special Gift"] = true
AL["Gently Shaken Gift"] = true
AL["Smokywood Pastures"] = true
AL["Noblegarden"] = true
