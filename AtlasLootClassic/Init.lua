...
local WOW_PROJECT_CATACLYSM_CLASSIC = _G.WOW_PROJECT_CATACLYSM_CLASSIC or 12 -- TODO: update later

AtlasLoot.RETAIL_VERSION_NUM 	= 99
AtlasLoot.CLASSIC_VERSION_NUM 	= 1
AtlasLoot.BC_VERSION_NUM 		= 2
AtlasLoot.WRATH_VERSION_NUM 	= 3
AtlasLoot.CATA_VERSION_NUM		= 4 -- TODO: fix
...
AtlasLoot.GAME_VERSION_TEXTURES = {
	...
	[AtlasLoot.CATA_VERSION_NUM] = 235509, -- TODO: update
